...
class Hero {
	...
	public function __construct($custom_options) {
		...
		if($this->options['image']) {
			$this->options['image'] = LazyImage::get_image($this->options['image'], [100], 'c-Hero__image js-parralax-image', true, false);
		}
	...
	public function render() { ?>
		...
		<div class="[ c-Hero <?= $this->options['classes']; ?> ]" g-component="Hero">
